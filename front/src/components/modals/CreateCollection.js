...
export const CreateCollection = ({show, onHide, type, path, id}) => {
    ...
    const addCollectionHandler = async () => {
        try {
            ...
            const response = await fetch('/api/col' + path, {
                method: 'POST',
                body: formData,
            ...
            <Modal.Body>
                <Form className="mx-4">
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control onChange={changeHandler} type="title" id="title" name="title"
                                      placeholder="My collection"/>
                    </Form.Group>
                    <Form.Select aria-label="Category" onChange={changeHandler} type="category" id="category"
                                 name="category">
                    ...
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control as="textarea" onChange={changeHandler} type="shortDesc" id="shortDesc"
                                      name="shortDesc" rows={3}/>
                    </Form.Group>
                </Form>
            </Modal.Body>
            <Modal.Footer>
