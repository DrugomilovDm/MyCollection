...
export const Item = ({item}) => {
    ...
    return (
        <Col md={3} lg={2} sm={5} xl={2} xs={5} className="mt-3 mx-3 d-flex justify-content-center">
            <Card style={{width: 150, cursor: 'pointer'}} border={"light"}>
                <div className="imgCont">
                    ...
                    <Image width={150} height={150} src={item.img || '/emptyItem.png'}
            ...
            <CreateItem show={changeItemVisible} onHide={() => setChangeItemVisible(false)} path='/changeItem'
                        type='change' itemId={item.id}/>
        </Col>
    );
};
