...
export const Collection = ({collection, md, xs, lg, sm}) => {
    ...
    return (
        <Col md={md} lg={lg} sm={sm} xs={xs} className="mt-3 mx-3 d-flex justify-content-center">
            <Card style={{width: 150, cursor: 'pointer'}} border="light">
                <div className="imgCont">
                    ...
                    <Image onClick={() => history.push('/Collection/' + collection.id)} width={150} height={150}
                           src={collection.img || '/empty.png'} roundedCircle/>
                </div>
            ...
            <CreateCollection show={changeColVisible} onHide={() => setChangeColVisible(false)} path='/changeCol'
                              type='change' id={collection.id}/>
        </Col>
    );
};
